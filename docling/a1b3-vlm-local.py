...
def openai_compatible_vlm_options(model: str, prompt: str, format: ResponseFormat):
...
def main():
    ...
    data_folder = "/Users/yaoo/Documents/01files/testpdf"
    input_doc_path = data_folder + "/html5canvas1page-pic.pdf"
